                ...
                <div className="rounded-2xl border px-8 py-4 normalFont shadow">
                    ...
                    <div className="grid gap-6 grid-cols-1 md:grid-cols-2 mt-5">
                        <div className="flex flex-col gap-1">
                            ...
                            <input value={firstname} onChange={(e) => setFirstname(e.target.value)} className="border rounded-lg focus:outline focus:outline-sky-500 px-2 py-1" type="text"/>
                        </div>
                        <div className="flex flex-col gap-1">
                            <p className="pl-1 text-gray-500">last name</p>
                            <input value={lastname} onChange={(e) => setLastname(e.target.value)} className="border focus:outline focus:outline-sky-500 rounded-lg px-2 py-1" type="text"/>
                        </div>
                        <div className="flex flex-col gap-1">
                            <p className="pl-1 text-gray-500">email</p>
                            <input value={email} onChange={(e) => setEmail(e.target.value)} className="border focus:outline focus:outline-sky-500 rounded-lg px-2 py-1" type="text"/>
                        </div>
                        <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <DatePicker className="border focus:outline focus:outline-sky-500 rounded-lg px-2 py-1 w-full" selected={startDate} onChange={(date) => setStartDate(date)} />
                        </div>
                        <div className="flex flex-col gap-1">
                        ...
                        <div onClick={() => saveUser()} className="flex justify-end md:col-start-2">
                            <button className="rounded-lg shadow-lg px-3 py-1 text-white bg-sky-700 flex justify-center items-center gap-2"><FaRegSave className="mb-0.5" />Save</button>
                        </div>
                    </div>
                </div>
            </div>
