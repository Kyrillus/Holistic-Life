...
function JarExperiment() {
    ...
    const [showOverview, setToggle] = useState(false)
                    ...
                    <div className="flex flex-col gap-8 justify-items-center">
                        <div className="flex flex-col gap-4 md:gap-0 md:flex-row justify-items-center place-content-between">
                            ...
                            <div className="flex  md:gap-0 items-center justify-center">
                                <Button onClick={() => setToggle(!showOverview)}
                                        className="md:w-40" colorScheme='blue' variant='outline'>show overview</Button>
                            </div>
                        </div>
                        <div>
                            <p className="text-center">Welcome to the start of your joruney to experience Lorem ipsum dolor
                                sit amet,
